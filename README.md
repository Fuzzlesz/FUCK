...
[GPL-3.0-or-later](LICENSE) with the [Modding Exception](EXCEPTIONS.md) and [GPL-3.0 Linking Exception](EXCEPTIONS.md).

The Modding Exception permits interoperability with Skyrim and proprietary hardware SDKs that cannot be relicensed. The GPL-3.0 Linking Exception permits linking with the specified Modding Libraries.

See [LICENSE](LICENSE) and [EXCEPTIONS.md](EXCEPTIONS.md) for the complete terms.
