...
public:
	...
	FUCK::WindowFlags GetFlags() const override { return FUCK::WindowFlags::kExtendBorder | FUCK::WindowFlags::kCloseOnEsc | FUCK::WindowFlags::kBlockVanity; }

	ImVec2 GetDefaultSize() const override
	{
		return FUCK::UIScale(465.0f, 510.0f);
	}
	ImVec2 GetDefaultPos() const override
	{
		return FUCK::Scale(1360.0f, 460.0f);
	}
